...
private _destTxt = composeText [
    ...
    parseText"Your destination grid is 1268 2058<br />You point will be orange and white and clearly visible<br />You are currently somewhere within the blue box marked on map<br />Your destination may be outside the blue box marked on map<br />"
];
...
"Lane 1 Hint" hintC [_destTxt, _rulesTxt, _questionsTxt];
