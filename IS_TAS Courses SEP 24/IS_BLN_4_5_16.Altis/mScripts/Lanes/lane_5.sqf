...
private _destTxt = composeText [
    ...
    parseText"Your destination grid is 0968 1425<br />You point will be orange and white and clearly visible<br />You are currently somewhere within the blue box marked on map<br />Your destination may be outside the blue box marked on map<br />"
];
...
"Lane 5 Hint" hintC [_destTxt, _rulesTxt, _questionsTxt];
...
for "_i" from 1 to 7 do {_caller addMagazine ["rhs_mag_30Rnd_556x45_M855A1_PMAG", 0]};
