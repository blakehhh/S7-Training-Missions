...
private _destTxt = composeText [
    ...
    parseText"Your destination grid is 0744 1293<br />You point will be orange and white and clearly visible<br />You are currently somewhere within the blue box marked on map<br />Your destination may be outside the blue box marked on map<br />"
];
...
"Lane 6 Hint" hintC [_destTxt, _rulesTxt, _questionsTxt];
