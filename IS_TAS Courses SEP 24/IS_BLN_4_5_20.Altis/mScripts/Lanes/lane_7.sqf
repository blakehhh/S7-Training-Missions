...
private _destTxt = composeText [
    ...
    parseText"Your destination grid is 1078 1760<br />You point will be orange and white and clearly visible<br />You are currently somewhere within the blue box marked on map<br />Your destination may be outside the blue box marked on map<br />"
];
...
"Lane 7 Hint" hintC [_destTxt, _rulesTxt, _questionsTxt];
