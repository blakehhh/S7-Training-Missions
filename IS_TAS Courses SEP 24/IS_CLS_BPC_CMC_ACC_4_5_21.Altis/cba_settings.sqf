...
//diwako_dui_nametags_fontGroup = "EtelkaMonospacePro";
//diwako_dui_nametags_fontGroupNameSize = 8;
//diwako_dui_nametags_fontName = "Bitstream";
...
//diwako_dui_radar_namelist_vertical_spacing = 0.876623;
...
force force force kat_circulation_bloodTypeSetting = 4;
