...
pr_walls_S = [pr_wall_lane0, pr_wall_lane1, pr_wall_lane2, pr_wall_lane3, pr_wall_lane4, pr_wall_lane5, pr_wall_lane6, pr_wall_lane7, pr_wall_lane8];
...
{
	[_x, getPos _x, _angleOffset, _offsetAdjustment, _height, 120] spawn _duplicate;
} foreach (pr_walls_S);
