...
[
    ...
    8, // targets per lane
    [  //sequence
        ["Load and ready your weapon",7],
        ["Assume a standing position and scan your lane",3],
        ["Range is hot!",1],
        ["Range is hot!",0,"FD_Course_Active_F"],
        [[1],3],
        [[5],3],
        ...
        [[2,4],5],
        [[7,5],5],
        ["Move to position two ",12],
        ["Reload one 10 round magazine",6],
        ["Assume a standing position and scan your lane",2],
        ["Range is hot!",1],
        ["Range is hot!",0,"FD_Course_Active_F",0],
        [[6],2],
        [[8],2],
